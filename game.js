...
class Vector {
  ...
  plus (vector) {
    ...
    throw new err ('Можно прибавлять к вектору только вектор типа Vector');
  }
...
class Actor {
  constructor(
    ...
    if (
      ...
      throw new err ('В качестве аргумента можно передавать только вектор типа Vector');
    }
    this.pos = pos;
    this.size = size;
    this.speed = speed;
  ...
  isIntersect(actor) {
    if (!(actor instanceof Actor) || !actor) {
      throw new err('В качестве аргумента необходимо передавать объект типа Actor');
    }
...
class Level {
  ...
  actorAt(actor) {
    if (!(actor instanceof Actor) || !actor) {
      throw new err (`В качестве аргументв необходимо передать объект типа Actor`);
    }
...
createActors(stringsArr = []) {
  ...
  parse(stringsArr = []) {
    const grid = this.createGrid(strigsArr);
